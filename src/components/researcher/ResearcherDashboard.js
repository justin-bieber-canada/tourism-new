...
export default function ResearcherDashboard() {
  ...
  useEffect(() => {
    if (user.user_id) {
      const data = getResearcherSummary(user.user_id);
      setSummary(data);
    }
  }, [user.user_id]);
    ...
    <div className="researcher-layout">
      ...
      <main className="researcher-main">
               ...
               {showNotifications && (
                 <div className="notification-dropdown" style={{
                   ...
                   <ul className="notification-list" style={{maxHeight: '300px', overflowY: 'auto'}}>
                    <li className="notification-item success" style={{margin: '5px 10px'}}>
                      <span className="notif-icon">✅</span>
                      <div className="notif-content">
                        <strong>Approved</strong>
                        <p>Your submission "Lalibela History Update" was approved.</p>
                      </div>
                    </li>
                    <li className="notification-item warning" style={{margin: '5px 10px'}}>
                      <span className="notif-icon">⚠️</span>
                      <div className="notif-content">
                        <strong>Action Required</strong>
                        <p>"Simien Park" requires more details on flora/fauna.</p>
                      </div>
                    </li>
                    <li className="notification-item info" style={{margin: '5px 10px'}}>
                      <span className="notif-icon">ℹ️</span>
                      <div className="notif-content">
                        <strong>System</strong>
                        <p>Welcome to the new Researcher Portal!</p>
                      </div>
                    </li>
                   </ul>
                 </div>
        ...
        <div className="dashboard-grid">
          ...
          {/* Notifications moved to bell icon, but keeping a summary or removing this panel if redundant. 
              User said "list even and again clicked hide them", implying the dropdown is the main way. 
              I'll replace this panel with something else or just hide it to avoid duplication. 
              Let's keep it as "Recent Activity" instead. */}
