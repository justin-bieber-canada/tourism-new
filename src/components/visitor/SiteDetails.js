...
export default function SiteDetails() {
  ...
  if (!site) return <div className="p-5">Loading...</div>;
    ...
    <div className="visitor-layout">
      ...
      <main className="visitor-main">
        <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <Link to={`/visitor/request-guide/${site.id}`} className="btn btn-primary">Request Guide for this Site</Link>
        </div>
        ...
        <div className="card p-3">
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <h4 className="text-primary">{site.price} ETB <small className="text-muted fs-6">+ {site.guideFee} ETB Guide Fee</small></h4>
