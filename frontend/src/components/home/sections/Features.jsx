...
function Features() {
  const features = [
    ...
    },
    {
      ...
      title: 'Expert Site Agents',
      description: 'Connect with certified site agents for an enriched historical experience.'
    },
    {
      icon: 'fa-person-breastfeeding',
      title: 'Site Agent Matching',
      description: 'Smart algorithm matches you with the perfect site agent based on your interests and language preferences.'
    },
    {
      icon: 'fa-angle-right',
      title: 'Rich Content',
